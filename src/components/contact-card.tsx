      ...
      <CardContent className="p-4">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Hỗ trợ siêu tốc 24/7</p>
          </div>
        </div>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  size="icon"
                  variant="outline"
                  className="rounded-full h-14 w-14 bg-background"
                >
                  <Link href={phoneLink}>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  asChild
                  size="icon"
                  className="rounded-full h-14 w-14 bg-[#0068FF] hover:bg-[#0052CC] text-white"
                >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  asChild
                  size="icon"
                  className="rounded-full h-14 w-14 bg-[#25D366] hover:bg-[#1DA851] text-white"
                >
