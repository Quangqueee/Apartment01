...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      // FIX: Đổi bg-background thành bg-white để input không bị trong suốt
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        // FIX: Đổi bg-popover thành bg-white và thêm z-[100] để đảm bảo luôn nổi lên trên và có nền trắng
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      // Thêm hover:bg-gray-100 để hiệu ứng hover rõ hơn trên nền trắng
