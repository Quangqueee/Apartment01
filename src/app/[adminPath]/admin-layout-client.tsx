    ...
    <SidebarProvider>
      ...
      <SidebarInset className="min-h-screen overflow-x-hidden bg-gray-50">
        <div className="w-full">
          <header className="sticky top-0 z-20 flex h-16 items-center gap-3 overflow-x-hidden border-b border-gray-200 bg-white px-4 shadow-sm md:hidden [@media(display-mode:standalone)]:pt-[var(--safe-top)] [@media(display-mode:standalone)]:h-[calc(4rem+var(--safe-top))]">
