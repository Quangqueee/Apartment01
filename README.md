...
| :------------- | :----------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------- |
| **01/08/2026** | Tối Ưu UI Chi Tiết Căn Hộ & Modal Chia Sẻ        | Bổ sung tải ảnh ZIP (B2B), chuyển Share Modal sang Bottom Sheet, thêm chia sẻ Messenger, cấu trúc lại cụm nút Floating trên Mobile và tùy chỉnh hiển thị `line-clamp`. | [Xem chi tiết](./2026-08-01-toi-uu-ui-chi-tiet-can-ho.md)          |
| **31/07/2026** | Khắc Phục Cache, Serialization & Tối Ưu Markdown | Xử lý triệt để lỗi chuyển đổi Timestamp Firebase sang Client Component, khắc phục kẹt cache giúp cập nhật căn hộ đẩy lên top, và tích hợp hiển thị Markdown chuẩn SEO. | [Xem chi tiết](./2026-07-31-xu-ly-cache-serialization-markdown.md) |
